                ...
                <div id="content">
                    ...
                    <div id="paymentForm" action="" method="">
                        ...
                        <div class="price-info">
                            <p class="total-price">총 금액: {{ $store.state.totalMoviePrice - $store.state.money}}원</p>
                        </div>
                        <div class="payment-methods">
                            <ModalView v-if="isModalViewed" @close-modal="isModalViewed = false">
                                <PaymentContentView v-bind:m_r_no="m_r_no"></PaymentContentView>
                            </ModalView>
...
export default {
    ...
    methods: {
        ...
        suc() {
            ...
            axios({
                method: 'post',
                url: 'http://localhost:9000/api/movie/order',
                headers: { "Content-Type": "application/json; charset=utf-8" },
                data: pointVo,
                responseType: 'json'
            }).then(response => {
                console.log(response.data);
                this.m_r_no = response.data.apiData;
